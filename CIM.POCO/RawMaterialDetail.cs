...
{
    [Serializable]
    public class RawMaterialDetail : VARawMaterialDetail
    {
        public static string GenFullLocationInfo(IList<RawMaterialDetail> RMDetailList)
        {
            try
            {
                ...
                string key;
                foreach (RawMaterialDetail rm in RMDetailList)
                {
        ...
        public static string GenLocations(IList<RawMaterialDetail> RMDetailList)
        {
            try
            {
                if (RMDetailList == null || RMDetailList.Count == 0) return "";
        ...
        public static string GenLocationsPlusKg(IList<RawMaterialDetail> RMDetailList)
        {
            try
            {
                if (RMDetailList == null || RMDetailList.Count == 0) return "";
