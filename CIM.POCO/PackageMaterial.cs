...
{
  [Serializable]
  public class PackageMaterial : POCOBase
  {
    ...
    public virtual int StockCount { get; set; } = 0;
    public virtual int SupplyCount { get; set; } = 0;
    public virtual double? StockWeight { get; set; } = 0;
    public virtual double? SupplyWeight { get; set; } = 0;
    public virtual double? SafeStock { get; set; } = 0;
    private DateTime _ExpireDate = DateTimeExtension.NilDate;
    public virtual DateTime ExpireDate
    {
      get { return _ExpireDate; }
      set
      {
        _ExpireDate = ((value.Year == 1) ? DateTimeExtension.NilDate : value);
      }
    }
    public virtual string DispExpireDate
    {
      get
      {
        return (ExpireDate == DateTimeExtension.NilDate) ? "" : ExpireDate.ToString("MM/dd/yyyy");
      }
    }
    private DateTime _RetestDate = DateTimeExtension.NilDate;
    public virtual DateTime RetestDate
    {
      get { return _RetestDate; }
      set
      {
        _RetestDate = (value.Year == 1) ? DateTimeExtension.NilDate : value;
      }
    }
    public virtual string DispRetestDate
    {
      get
      {
        return (RetestDate == DateTimeExtension.NilDate) ? "" : RetestDate.ToString("MM/dd/yyyy");
      }
    }
    ...
    public virtual int OverdueLevelQuarantineArea
    {
      get
      {
        if (LastQuarantineDate.Year == 1) return 0;// || bReleased) return 0;
    ...
    // memory data
    public virtual int ReservedCount { get; set; } = 0;
  }
}
