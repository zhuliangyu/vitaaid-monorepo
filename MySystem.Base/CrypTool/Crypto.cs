...
namespace CrypTool
{
    public static class Crypto
    {
        ...
        private static readonly string _salt = "32168421";

        public static string Encrypt(this string text, string salt = null)
        {
            if (salt == null)
            {
                salt = _salt;
        ...
        public static string Decrypt(this string text, string salt = null)
        {
            if (salt == null)
            {
                salt = _salt;
