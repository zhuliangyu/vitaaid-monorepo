...
var ReactImageMagnify = (function (_React$Component) {
  ...
  function ReactImageMagnify(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ReactImageMagnify.__proto__ || Object.getPrototypeOf(ReactImageMagnify)).call(this, props),
    );
  ...
  _createClass(ReactImageMagnify, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var cursorOffset = getLensCursorOffset(
          smallImage,
          largeImage,
    ...
    },
    {
      ...
      get: function get() {
        ...
        var computedEnlargedImagePosition = isTouchDetected
