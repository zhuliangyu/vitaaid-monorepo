...
export const orderCommentSlice = createSlice({
  ...
  reducers: {
    orderCommentChanged: (state, action) => {
      state.value = action.payload;
    },
  },
});

export const { orderCommentChanged } = orderCommentSlice.actions;

export const orderComment = (state: any) => state.orderComment.value;
