...
export const dropShipSlice = createSlice({
  name: 'dropShip',
  initialState: {
    value: false,
  },
  reducers: {
    dropShipChanged: (state, action) => {
      state.value = action.payload;
    },
  },
});

export const { dropShipChanged } = dropShipSlice.actions;

export const dropShip = (state: any) => state.dropShip.value;
