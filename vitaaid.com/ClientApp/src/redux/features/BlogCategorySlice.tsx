...
export const blogCategorySlice = createSlice({
  ...
  initialState: {
    value:
      sessionStorage.getItem('blogCategory') == null ? '' : sessionStorage.getItem('blogCategory'),
  },
  reducers: {
    blogCategoryChanged: (state, action) => {
      sessionStorage.setItem('blogCategory', action.payload);
      state.value = action.payload;
    },
  },
});

export const { blogCategoryChanged } = blogCategorySlice.actions;
export const blogCategory = (state: any) => state.blogCategory.value;
