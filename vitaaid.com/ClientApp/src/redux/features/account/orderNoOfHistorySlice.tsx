...
export const orderNoOfHistorySlice = createSlice({
  name: 'orderNoOfHistory',
  initialState: {
    value: '',
  },
  reducers: {
    orderNoOfHistoryChanged: (state, action) => {
      state.value = action.payload;
    },
  },
});

export const { orderNoOfHistoryChanged } = orderNoOfHistorySlice.actions;
export const orderNoOfHistory = (state: any) => state.orderNoOfHistory.value;
export default orderNoOfHistorySlice.reducer;
