...
namespace MyToolkit.Base.Extensions
{
    public static class ListBoxExtension
    {
        public static readonly DependencyProperty HorizontalOffsetProperty = DependencyProperty.RegisterAttached("HorizontalOffset",
            typeof(double), typeof(ListBoxExtension), new UIPropertyMetadata(0.0, OnHorizontalOffsetChanged));
        ...
        public static void CenterSelectedItem(this ListBox listBox)
        {
            ...
            var scrollViewer = listBox.FindVisualDescendantByType("ScrollViewer");//.FindVisualDescendantByType<ScrollViewer>();
            if (scrollViewer == null)
            {
                return;
            }
            ...
            var scrollableArea = ((ScrollViewer)scrollViewer).ActualWidth;
            ...
            horizontalAnimation.From = ((ScrollViewer)scrollViewer).HorizontalOffset;
            horizontalAnimation.To = toValue;
            horizontalAnimation.DecelerationRatio = .2;
            horizontalAnimation.Duration = new Duration(TimeSpan.FromMilliseconds(300));//WizardConfiguration.AnimationDuration);
